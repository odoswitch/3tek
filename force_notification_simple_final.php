<?php
echo "=== FORCE NOTIFICATION SIMPLE FINAL ===\n\n";
...
echo "\n🔧 ÉTAPE 2: Création d'un utilisateur complet...\n";

// Créer un utilisateur complet avec tous les champs requis
$createUserCommand = "php bin/console doctrine:query:sql \"INSERT INTO user (email, name, lastname, password, roles, office, phone, address, code, ville, pays, is_verified) VALUES ('test@example.com', 'Test', 'User', '\$2y\$13\$test', '[]', 'Test Office', '0123456789', 'Test Address', '12345', 'Test City', 'Test Country', 1)\"";
