...
// Vérifier les lots
$lotCommand = "php bin/console doctrine:query:sql \"SELECT id, name, statut, quantite FROM lot LIMIT 3\"";
...
echo "\n🔍 ÉTAPE 2: Vérification des files d'attente...\n";

// Vérifier les files d'attente
$fileCommand = "php bin/console doctrine:query:sql \"SELECT id, lot_id, user_id, position, statut FROM file_attente LIMIT 3\"";
...
echo "\n🔍 ÉTAPE 3: Vérification des commandes...\n";

// Vérifier les commandes
$commandeCommand = "php bin/console doctrine:query:sql \"SELECT id, user_id, lot_id, statut FROM commande LIMIT 3\"";
...
echo "\n🎯 POUR TESTER LA LOGIQUE AUTOMATIQUE:\n";
